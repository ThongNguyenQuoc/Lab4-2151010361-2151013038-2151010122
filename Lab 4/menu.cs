...
namespace Lab_4
{
    public partial class menu : Form
    {
        ...
        {
            cmd = conn.CreateCommand();
            cmd.CommandText = "insert into KhachHang values(N'" + txtMaKhachHang.Text + "', N'" + txtTenKhachHang.Text + "',  N'" + txtDiaChiKhachHang.Text + "',  N'" + txtSoDienThoaiKhachHang.Text + "',  N'" + txtEmailKhachHang.Text + "')";
            cmd.ExecuteNonQuery();
            loadData();
        }
        ...
        {
            cmd = conn.CreateCommand();
            cmd.CommandText = "update KhachHang set MaKH = N'" + txtMaKhachHang.Text + "', TenKH = '" + txtTenKhachHang.Text + "', DiaChi = '" + txtDiaChiKhachHang.Text + "', SoDienThoai = '" + txtSoDienThoaiKhachHang.Text + "', Email = '" + txtEmailKhachHang.Text + "' where MaKH = '" + txtMaKhachHang.Text + "'";
            cmd.ExecuteNonQuery();
            loadData();
        }
        ...
        {
            cmd = conn.CreateCommand();
            cmd.CommandText = "insert into DonDatHang values(N'" + txtMaDatHang.Text + "', N'" + dateTimeDatHang.Value.ToString("yyyy-MM-dd") + "',  N'" + txtTrangThai.Text + "',  N'" + txtMaKhachHangFK.Text + "',  N'" + txtMaNhanVien.Text + "')";
            cmd.ExecuteNonQuery();
            loadData();
        }
        ...
        {
            cmd = conn.CreateCommand();
            cmd.CommandText = "update DonDatHang set MaĐH = N'" + txtMaDatHang.Text + "', NgayĐH = '" + dateTimeDatHang.Value.ToString("yyyy-MM-dd") + "', TrangThai = '" + txtTrangThai.Text + "', MaKH = '" + txtMaKhachHangFK.Text + "', MaNV = '" + txtMaNhanVien.Text + "' where MaĐH = '" + txtMaDatHang.Text + "'";
            cmd.ExecuteNonQuery();
            loadData();
        }
    }
